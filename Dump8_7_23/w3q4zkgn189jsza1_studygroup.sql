...
CREATE TABLE `studygroup` (
  `studygroup_id` int NOT NULL AUTO_INCREMENT,
  `studygroup_name` varchar(255) DEFAULT NULL,
...
INSERT INTO `studygroup` VALUES (1,'วศ.บ คอมพิวเตอร์ (เทียบโอน)'),(2,'วศ.บ คอมพิวเตอร์ (4 ปี)');
...
-- Dump completed on 2023-08-07 13:42:52
