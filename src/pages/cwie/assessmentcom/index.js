...
const SurveyForm = () => {
  ...
  useEffect(() => {
    ...
    setSum_12(id1 + id2 + id3 + id4 + id5 + id6 + id7 + id8 + id9 + id10 + id11 + id12 + id13 + id14 + id15 + id16 + id17 + id18 + id19);
  }, [costnSum1_2]);
            ...
            <form id='formqsys' name='formqsys' method='post'>
              <Paper sx={{ width: '70%', margin: 'auto' }}>
                <table width='100%' border='1' cellPadding='0' cellSpacing='0'>
                  ...
                  <tbody>
                    <tr>
                      <td height='30'>&nbsp; 1. ความเข้าใจในปรัชญาของสหกิจศึกษา <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1.1 เจ้าหน้าที่ระดับบริหารและฝ่ายบุคคล</td>
                    ...
                    <tr>
                      <td height='30'>&nbsp; 2. การจัดการ และสนับสนุน <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2.1  การประสานงานด้านการจัดการดูแลนักศึกษาภายในสถานประกอบการ
                                                <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ระหว่างฝ่ายบุคคลและ Job Supervisor</td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 2.2  การให้คําแนะนําดูแลนักศึกษาของฝ่ายบริหารบุคคล <br/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(ปฐมนิเทศ ระเบียบวินัย ลางาน สวัสดิการ จ่ายตอบแทน)  </td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp; 3. ปริมาณงานที่นักศึกษาได้รับมอบหมาย <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  3.1ปริมาณงานที่นักศึกษาได้รับมอบหมาย </td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp; 4.  คุณภาพงาน <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  4.1 คุณลักษณะงาน </td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  4.2  งานที่ได้รับมอบหมายตรงกับสาขาวิชาเอกของนักศึกษา </td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  4.4  งานที่ได้รับมอบหมายตรงกับความสนใจของนักศึกษา </td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  4.5  ความเหมาะสมของหัวข้อรายงานที่นักศึกษาได้รับ <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp; 5. การมอบหมายงานและนิเทศงาน ของ Supervisor <br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5.1 มี Supervisor ดูแลนักศึกษาตั้งแต่วันแรกที่เข้างาน  </td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  5.2  ความรู้และประสบการณ์วิชาชีพของ Supervisor  <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  5.3  เวลาที่ Supervisor ให้แก่นักศึกษาด้านการปฏิบัติงาน <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  5.4  เวลาที่ Supervisor ให้แก่นักศึกษาด้านการเขียนรายงาน  <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  5.5  ความสนใจของ Supervisor ต่อการสอนงาน และสั่งงาน  <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  5.6  การให้ความสําคัญต่อการประเมินผลการปฏิบัติงานและเขียน รายงาน
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ของ Supervisor <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  5.7  ความพร้อมของอุปกรณ์เครื่องมือสําหรับนักศึกษา <br/>
                                      &nbsp;(พิจารณาในกรณีนักศึกษา Co-op ซึ่งไปปฏิบัติงานชั่วคราว) <br/></td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 5.8 ความพร้อมของอุปกรณ์เครื่องมือสําหรับนักศึกษา</td>
                      <td height='30' align='center'>
                    ...
                    <tr>
                      <td height='30'>&nbsp;<border> 6. สรุปคุณภาพโดยรวมของสถานประกอบการแห่งน </border> </td>
                      <td height='30' align='center'>
